...
const refreshToken = async (req, res) => {
  ...
  /* if payload is same and same is secret key jwt always produces same token in cookies but because jwt inserts time/every time new token is generated it has different value. */
